...
public class RedPacketTest {
    ...
    public Long[] allocate(Long amount, int number) {
        ...
        checkArgument(amount > 0, "amount must greater than 0");
        checkArgument(number > 0, "number must greater than 0");
        checkArgument(amount >= number, "amount must greater than or equals number");
